...
import com.example.rollingBall.arena.BounceWall;
...
public class BounceWallAdapter extends TypeAdapter<BounceWall> {

    @Override
    public void write(JsonWriter writer, BounceWall wall) throws IOException {
        writer.beginObject();
        writer.name("width");
    ...
    @Override
    public BounceWall read(JsonReader reader) throws IOException {
        double width = 10;
        double height = 10;
        double depth = 10;
        double positionX = 10;
        ...
        reader.endObject();
        return new BounceWall(width, height, depth,
